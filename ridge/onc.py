...
full_data = pd.read_csv('/kaggle/input/dspvn30/save_data.csv')
data = full_data[full_data.Date >= '2021']

study = joblib.load(open("/kaggle/input/dspvn30/ridgemodel.pkl", "rb"))
trials = study.trials
...
# Save to disk
with open('top_10_features_per_cluster_ridge.pkl', 'wb') as f:
    pickle.dump(top_10_features_per_cluster, f)

# Save to disk
with open('top_10_list_ridge.pkl', 'wb') as f:
